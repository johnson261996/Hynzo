...
class TechnologyNewsWidget extends StatefulWidget{
  final List<NewsContentDataModel>? allContent;
  const TechnologyNewsWidget({Key? key,this.allContent}) : super(key: key);

  @override
  State<TechnologyNewsWidget> createState() => _TechnologyNewsWidgetState();
}

class _TechnologyNewsWidgetState extends State<TechnologyNewsWidget> {
