...
class WorldNewsWidget extends StatefulWidget{
  final List<NewsContentDataModel>? allContent;
  const WorldNewsWidget({Key? key,this.allContent}) : super(key: key);

  @override
  State<WorldNewsWidget> createState() => _WorldNewsWidgetState();
}

class _WorldNewsWidgetState extends State<WorldNewsWidget> {
