...
class ScienceNewsWidget extends StatefulWidget{
  final List<NewsContentDataModel>? allContent;
  const ScienceNewsWidget({Key? key,this.allContent}) : super(key: key);

  @override
  State<ScienceNewsWidget> createState() => _ScienceNewsWidgetState();
}

class _ScienceNewsWidgetState extends State<ScienceNewsWidget> {
