...
import 'package:invent_chat/core/models/chat_model.dart';
        ...
        itemBuilder: (BuildContext context, int index) {
          return Container(
            ...
            decoration: BoxDecoration(
              color: allChats[index].unreadCount! > 0 ? AppColors.lighterblue.withOpacity(0.3) : AppColors.white,
