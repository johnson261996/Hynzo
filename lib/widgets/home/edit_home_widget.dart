        ...
        height: 10,
          ...
          Expanded(
            ...
            itemBuilder: (context, index) {
              // int i = index % 2;
              // color= (index % 2 == 0 ? Colors.cyan[100] : Colors.blue[300]) as Color;
              // print('color index: $index' + '\tvalue $i');
              return Card(
                        ...
                        Container(
                          ...
                          GestureDetector(
                            ...
                            setState(() {
                              ...
                              //print("_items[index].isSelected:$index :" + _items[index].isSelected.toString());
