...
class _ProfileContainerState extends State<ProfileContainer> {
 ...
 @override
  ...
  Future<UserProfileModel> getUserData() async {
    UserProfileModel userResponse = await _userProvider!.getUser(widget.args['id']);
    return userResponse;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ProfileWidget(getUserDetails: getUserData,args: widget.args, addUser: createChannel,
    );
  }
}
